...
class RenderSession {
	...
	private function getCachedBitmapBounds (shape:DisplayObject, bounds:Rectangle, transform:Matrix ) {
		...
		if (graphics!=null) {
			CanvasGraphics.render (graphics, this, shape.__cacheAsBitmapMatrix, shape.__worldColorTransform.__isDefault() ? null : shape.__worldColorTransform);
	...
	private function flatten (shape:DisplayObject, bmd:BitmapData ) {
		...
		var graphics = shape.__graphics;
		if (graphics!=null) {
			CanvasGraphics.render (graphics, this, IDENTITY, shape.__worldColorTransform.__isDefault() ? null : shape.__worldColorTransform);
